  ...
  return (
    <>
      <section id="dashboard" className="dashboard">
        ...
        {/* task columns */}
        <section id="main-task-columns" className='main-task-columns'>
